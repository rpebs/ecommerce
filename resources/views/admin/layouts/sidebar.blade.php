        ...
        <div class="sidebar-wrapper active">
            <div class="sidebar-header position-relative">
                <div class="d-flex justify-content-between align-items-center">
                    <div class="logo">
                        <a href="index.html"><img src="/mazer/dist/assets/images/logo/logo.svg" alt="Logo"
                                srcset=""></a>
                    </div>
            ...
            <div class="sidebar-menu">
                <ul class="menu">
                    ...
                    <li class="sidebar-item {{ $active == 'addstock' ? 'active' : '' }}">
                        <a href="{{ route('addstock') }}" class='sidebar-link'>
